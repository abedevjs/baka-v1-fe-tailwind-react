function Policy() {
  return (
    <div className=" w-full px-4 text-sm sm:px-0 sm:text-xs">
      <h1 className=" mb-4 text-2xl font-semibold text-center capitalize">
        PRIVACY POLICY
      </h1>

      <p>
        This Privacy Policy is prepared by{" "}
        <span className=" italic">BAKA BAGASI</span> and whose registered
        address is{" "}
        <span className=" italic">
          Infiniti Office, Belleza BSA 1st Floor Permata Hijau, Kebayoran Lama
      ...
      <p>
        <span className=" font-semibold">Information you supply to us.</span>{" "}
        You may supply us with information about you by filling in forms on our
        website or social media. This includes information you provide when you
        submit a contact/inquiry form. The information you give us may include
        but is not limited to, your name, address, e-mail address, and phone
        number.
      </p>
      ...
      <p>
        ...
        <span className="italic">bonsoir.abe@gmail.com</span>. We will provide
        your personal data to you within the statutory time frames. To enable us
        to trace any of your personal data that we may be holding, we may need
        to request further information from you. If you complain about how we
      ...
      <h2 className=" mt-4 mb-1 text-base font-semibold">Contact</h2>
      <p>
        Questions, comments, and requests regarding this privacy policy are
        welcomed and should be addressed to{" "}
        <span className="italic">
          Muhammad Akbar, by email: bonsoir.abe@gmail.com.
        </span>
      </p>
    </div>
  );
